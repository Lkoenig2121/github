  ...
  return (
    <div className="min-h-screen bg-gray-50">
          ...
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center space-x-4">
              ...
              <nav className="flex space-x-4">
                ...
                <Link href="/issues" className="text-gray-900 font-semibold hover:text-gray-700">
                  Issues
                </Link>
              </nav>
            </div>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="mb-6">
          <h1 className="text-3xl font-bold text-gray-900 mb-4">All Issues</h1>
                ...
                <div className="flex items-start justify-between">
                  <div className="flex-1">
                    <div className="flex items-center space-x-2 mb-2">
                      ...
                      <Link
                        href={`/repositories/${issue.repoId}/issues`}
                        className="text-sm text-gray-500 hover:text-indigo-600"
                      >
                        {getRepositoryName(issue.repoId)}
                      </Link>
                    </div>
